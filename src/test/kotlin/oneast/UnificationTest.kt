...
//
//    private fun assertOk(context: SearchState, program: Example) = assertTrue(ok(context,
// program))
//
...
//        assertEquals(
//            OneUnification(context1, emptyList()).type(App(f, g))!!.toNode(), Arrow(I, Arrow(I,
// I))
//        )
//
...
//        assertEquals(
//            OneUnification(context2, emptyList()).type(App(f, g))!!.toNode(), Arrow(I, Arrow(I,
// I))
//        )
//    }
//
...
//         */
//        val context =
//            makeContext("f" to Arrow(aba, Arrow(a, Arrow(b, a))), "g" to aai, "0" to I, "true" to
// B)
//        val example = App(f, g)
//
//        assertOk(context, example)
...
//     * OneUnification properly rejects types where a type constructor is used with the wrong
// number
...
//     * When trying to unify f's parameter (List with 1 param) with x (List with 2 params), the
// arity
...
//            is InstantiationTy -> error("Unreachable pattern match - convert Instantiation to
// node")
