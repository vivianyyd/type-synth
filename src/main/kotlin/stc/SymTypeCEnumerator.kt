...
class SymTypeCEnumerator(
    ...
    private fun enumerate(
        ...
        when (t) {
            ...
            is Function -> {
                // TODO Think about this harder: The RHS of a function could be "fresh" if that fn
                // is itself a parameter,
                //   since 'a -> bool is a subtype of 'a -> 'b. However, this is not HM... Only
                // matters when we have subtyping
            ...
            is sta.Variable -> {
                ...
                // VLs can only appear in the rightmost position. VBs can actually have been
                // previously bound in a label
                else if (pickedLabel)
