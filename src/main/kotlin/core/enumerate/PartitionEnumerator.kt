...
/**
 * Partitions shallowest holes into named variables and label thunks, which are unified after committing.
 */
class PartitionEnumerator<L : Language>(
    ...
    private fun fill(
        ...
        // TODO it helps to refer to the hole's expansions since there may be additional constraints on variables
