...
fun applyBinding(t: SymTypeC, varId: Int, tId: Int, sub: SymTypeC): SymTypeC =
    when (t) {
        is L,
        is VB,
        is VL -> t
                ...
                is F -> {
                    ...
                    val riteBindings =
                        leftBindings
                            ...
                            ?.let { unify(it, arg.rite, labelClasses) }
...
fun apply(fn: F, arg: SymTypeC, labelClasses: OldUnionFind): SymTypeC? {
    ...
    return unify(fn.left, arg, labelClasses)?.let { applyBindings(fn.rite, it) }
}
